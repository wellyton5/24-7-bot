...
def find_truck_case_insensitive():
    ...
    try:
        ...
        print("--- BUSCA CASE-INSENSITIVE EM CFGEVENTGROUPS.XML ---")
        lines = content.splitlines()
        for i, line in enumerate(lines):
            if re.search(r"Truck_01_Covered", line, re.IGNORECASE):
